...
const questionPrompt = PromptTemplate.fromTemplate(
  `ou are a helpful AI assistant. Use the following pieces of context to answer the question at the end. The answer have to be in this form: xx:xx:xx.xxx --> xx:xx:xx.xxx.
  If you don't know the answer, just say you don't know. DO NOT try to make up an answer.
...
export const makeChain = (vectorstore: PineconeStore) => {
  ...
  //const model = new OpenAI({ openAIApiKey: process.env.OPEN_AI_KEY ?? '',modelName: "gpt-3.5-turbo" });
